...
use elexeum_primitives::v1::{AvailabilityBitfield, CoreState, Hash, ValidatorIndex};
		...
		let metrics = MetricsInner {
			bitfields_signed_total: prometheus::register(
				prometheus::Counter::new(
					"elexeum_parachain_bitfields_signed_total",
			...
			run: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"elexeum_parachain_bitfield_signing_run",
