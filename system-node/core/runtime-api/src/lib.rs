...
const API_REQUEST_TASK_NAME: &str = "elexeum-runtime-api-request";
		...
		let metrics = MetricsInner {
			chain_api_requests: prometheus::register(
				prometheus::CounterVec::new(
					prometheus::Opts::new(
						"elexeum_parachain_runtime_api_requests_total",
			...
			make_runtime_api_request: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"elexeum_parachain_runtime_api_make_runtime_api_request",
