...
use elexeum_node_subsystem::{SubsystemError, SubsystemResult};
...
impl From<CandidateVotes> for elexeum_node_primitives::CandidateVotes {
	fn from(db_votes: CandidateVotes) -> elexeum_node_primitives::CandidateVotes {
		elexeum_node_primitives::CandidateVotes {
...
impl From<elexeum_node_primitives::CandidateVotes> for CandidateVotes {
	fn from(primitive_votes: elexeum_node_primitives::CandidateVotes) -> CandidateVotes {
		CandidateVotes {
...
mod tests {
	...
	use elexeum_primitives::v1::{Hash, Id as ParaId};
