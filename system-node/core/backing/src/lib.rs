...
fn minimum_votes(n_validators: usize) -> usize {
	// Runtime change going live, see: https://github.com/paritytech/elexeum/pull/4437
	...
	// we want to err on the higher value for secured block production:
...
async fn make_pov_available(
	...
	pov: Arc<PoV>,
	candidate_hash: CandidateHash,
	validation_data: elexeum_primitives::v1::PersistedValidationData,
		...
		let metrics = MetricsInner {
			signed_statements_total: prometheus::register(
				prometheus::Counter::new(
					"elexeum_parachain_candidate_backing_signed_statements_total",
			...
			candidates_seconded_total: prometheus::register(
				prometheus::Counter::new(
					"elexeum_parachain_candidate_backing_candidates_seconded_total",
			...
			process_second: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"elexeum_parachain_candidate_backing_process_second",
			...
			process_statement: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"elexeum_parachain_candidate_backing_process_statement",
			...
			get_backed_candidates: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"elexeum_parachain_candidate_backing_get_backed_candidates",
...
pub type CandidateBackingSubsystem<Spawner> =
	elexeum_node_subsystem_util::JobSubsystem<CandidateBackingJob, Spawner>;
