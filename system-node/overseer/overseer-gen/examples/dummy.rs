...
use elexeum_node_network_protocol::WrongVariant;
use elexeum_overseer_gen::*;

/// Concrete subsystem implementation for `MsgStrukt` msg type.
#[derive(Default)]
pub struct AwesomeSubSys;

impl ::elexeum_overseer_gen::Subsystem<XxxSubsystemContext<MsgStrukt>, Yikes> for AwesomeSubSys {
...
impl ::elexeum_overseer_gen::Subsystem<XxxSubsystemContext<Plinko>, Yikes> for GoblinTower {
...
impl From<elexeum_overseer_gen::OverseerError> for Yikes {
	fn from(_: elexeum_overseer_gen::OverseerError) -> Yikes {
		Yikes
	}
}

impl From<elexeum_overseer_gen::mpsc::SendError> for Yikes {
	fn from(_: elexeum_overseer_gen::mpsc::SendError) -> Yikes {
		Yikes
	}
}
