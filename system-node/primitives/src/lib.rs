...
//!
//! Unlike the `elexeum-primitives` crate, these primitives are only used on the node-side,
...
pub use elexeum_parachain::primitives::BlockData;
...
/// On elexeum this is 1 day, and on elexeum it's 6 hours.
///
...
///
/// - does not contain the erasure root; that's computed at the elexeum level, not at Cumulus
/// - contains a proof of validity.
#[derive(Clone, Encode, Decode)]
pub struct Collation<BlockNumber = elexeum_primitives::v1::BlockNumber> {
