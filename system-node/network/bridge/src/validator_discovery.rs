...
pub use elexeum_node_network_protocol::authority_discovery::AuthorityDiscovery;
...
mod tests {
	...
	use elexeum_node_network_protocol::{request_response::outgoing::Requests, PeerId};
