...
use elexeum_node_network_protocol::{authority_discovery::AuthorityDiscovery, PeerId};
use sp_application_crypto::AppKey;
use sp_keyring::Sr25519Keyring;
use sp_keystore::{SyncCryptoStore, SyncCryptoStorePtr};

use elexeum_node_primitives::{DisputeMessage, SignedDisputeStatement};
...
use elexeum_primitives_test_helpers::dummy_candidate_descriptor;
...
impl AuthorityDiscovery for MockAuthorityDiscovery {
	async fn get_addresses_by_authority_id(
		&mut self,
		_authority: elexeum_primitives::v1::AuthorityDiscoveryId,
	...
	async fn get_authority_ids_by_peer_id(
		&mut self,
		peer_id: elexeum_node_network_protocol::PeerId,
	) -> Option<HashSet<elexeum_primitives::v1::AuthorityDiscoveryId>> {
