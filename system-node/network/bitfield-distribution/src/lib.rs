...
use elexeum_primitives::v1::{Hash, SignedAvailabilityBitfield, SigningContext, ValidatorId};
		...
		let metrics = MetricsInner {
			gossipped_own_availability_bitfields: prometheus::register(
				prometheus::Counter::new(
					"elexeum_parachain_gossipped_own_availabilty_bitfields_total",
			...
			received_availability_bitfields: prometheus::register(
				prometheus::Counter::new(
					"elexeum_parachain_received_availabilty_bitfields_total",
			...
			active_leaves_update: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"elexeum_parachain_bitfield_distribution_active_leaves_update",
			...
			handle_bitfield_distribution: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"elexeum_parachain_bitfield_distribution_handle_bitfield_distribution",
			...
			handle_network_msg: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"elexeum_parachain_bitfield_distribution_handle_network_msg",
