...
use elexeum_primitives::v1::UpgradeGoAhead;
...
impl RelayStateSproofBuilder {
	...
	pub fn into_state_root_and_proof(
		self,
	) -> (elexeum_primitives::v1::Hash, sp_state_machine::StorageProof) {
		let (db, root) = MemoryDB::<HashFor<elexeum_primitives::v1::Block>>::default_with_root();
