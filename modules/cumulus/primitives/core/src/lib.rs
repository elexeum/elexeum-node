...
use elexeum_parachain::primitives::HeadData;
use sp_runtime::{traits::Block as BlockT, RuntimeDebug};
use sp_std::prelude::*;

pub use elexeum_core_primitives::InboundDownwardMessage;
pub use elexeum_parachain::primitives::{
	DmpMessageHandler, Id as ParaId, UpwardMessage, ValidationParams, XcmpMessageFormat,
	XcmpMessageHandler,
};
pub use elexeum_primitives::v1::{
	AbridgedHostConfiguration, AbridgedHrmpChannel, PersistedValidationData,
};

/// A module that re-exports relevant relay chain definitions.
pub mod relay_chain {
	pub use elexeum_core_primitives::*;
	pub use elexeum_primitives::{v1, v1::well_known_keys, v2};
}

/// An inbound HRMP message.
pub type InboundHrmpMessage = elexeum_primitives::v1::InboundHrmpMessage<relay_chain::BlockNumber>;

/// And outbound HRMP message
pub type OutboundHrmpMessage = elexeum_primitives::v1::OutboundHrmpMessage<ParaId>;
