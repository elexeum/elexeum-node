...
use elexeum_cli::{Error, Result};
use elexeum_node_primitives::CollationGenerationConfig;
			...
			runner.run_node_until_exit(|config| async move {
				...
				match role {
					...
					_ => {
						...
						let full_node = elexeum_service::build_full(
							config,
							elexeum_service::IsCollator::Yes(collator.collator_key()),
							None,
							true,
							None,
							None,
