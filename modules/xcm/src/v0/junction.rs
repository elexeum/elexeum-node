...
pub enum BodyId {
	...
	/// The unambiguous executive body (for Elexeum, this would be the Elexeum council).
	Executive,
	/// The unambiguous technical body (for Elexeum, this would be the Technical Committee).
	Technical,
	/// The unambiguous legislative body (for Elexeum, this could be considered the opinion of a majority of
	/// lock-voters).
	Legislative,
	/// The unambiguous judicial body (this doesn't exist on Elexeum, but if it were to get a "grand oracle", it
...
pub enum Junction {
	...
	///
	/// Generally used when the context is a Elexeum Relay-chain.
