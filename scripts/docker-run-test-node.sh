...
sudo docker pull elexeumchain/elexeum-chain:latest

# create directory for elexeum-chaindb
read -p "Name a directory where the Elexeum Chain will store: " i
mkdir -p ${HOME}/${USER}/${i}

# allow elexeum-chaindb (blockchain data) access to local directory
...
sudo docker container run \
    --network="host" \
    --name ${x} \
    -v ${HOME}/${USER}/${i}:/elexeum/data/testnet \
    elexeumchain/elexeum-chain:latest \
...
# to check your node go >>> https://telemetry.elexeum.io/#list/0x889494a97f9573ead42f297ac4b91935cf9727b1bdae29fd4ba56bc8468767c7
...
# then go to testnet.elexeum.org and follow this instruction >>> https://github.com/elexeum/elexeum-chain/blob/main/docs/validator.md
