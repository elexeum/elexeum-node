...
use log::info;
use elexeum_node_core_pvf::sp_maybe_compressed_blob;
use elexeum_performance_test::{
...
pub fn host_perf_check() -> Result<(), PerfCheckError> {
	...
	let wasm_code =
		elexeum_performance_test::WASM_BINARY.ok_or(PerfCheckError::WasmBinaryMissing)?;
