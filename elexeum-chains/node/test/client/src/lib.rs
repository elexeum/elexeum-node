...
//! A Elexeum test client.
//!
//! This test client is using the Elexeum test runtime.

mod block_builder;

use sc_service::client;
use elexeum_primitives::v1::Block;
use sp_core::storage::Storage;
use sp_runtime::BuildStorage;

pub use block_builder::*;
pub use elexeum_test_runtime as runtime;
pub use elexeum_test_service::{
	construct_extrinsic, construct_transfer_extrinsic, Client, FullBackend,
	ElexeumTestExecutorDispatch,
};
...
pub type Executor = client::LocalCallExecutor<
	Block,
	FullBackend,
	sc_executor::NativeElseWasmExecutor<ElexeumTestExecutorDispatch>,
>;

/// Test client builder for Elexeum.
...
impl substrate_test_client::GenesisInit for GenesisParameters {
	fn genesis_storage(&self) -> Storage {
		elexeum_test_service::chain_spec::elexeum_local_testnet_genesis()
			.build_storage()
...
mod tests {
	...
	fn ensure_test_client_can_push_extrinsic() {
		...
		block_builder.push_elexeum_extrinsic(transfer).expect("Pushes extrinsic");
