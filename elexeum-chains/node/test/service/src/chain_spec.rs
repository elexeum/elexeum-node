...
use elexeum_primitives::v1::{AccountId, AssignmentId, ValidatorId, MAX_CODE_SIZE, MAX_POV_SIZE};
use elexeum_service::chain_spec::{get_account_id_from_seed, get_from_seed, Extensions};
use elexeum_test_runtime::BABE_GENESIS_EPOCH_CONFIG;
...
pub type ElexeumChainSpec =
	service::GenericChainSpec<elexeum_test_runtime::GenesisConfig, Extensions>;

/// Local testnet config (multivalidator Alice + Bob)
pub fn elexeum_local_testnet_config() -> ElexeumChainSpec {
	ElexeumChainSpec::from_genesis(
		"Local Testnet",
		"local_testnet",
		ChainType::Local,
		|| elexeum_local_testnet_genesis(),
		vec![],
		None,
...
pub fn elexeum_local_testnet_genesis() -> elexeum_test_runtime::GenesisConfig {
...
fn elexeum_testnet_genesis(
...
) -> elexeum_test_runtime::GenesisConfig {
	use elexeum_test_runtime as runtime;
	...
	runtime::GenesisConfig {
		...
		configuration: runtime::ConfigurationConfig {
			config: elexeum_runtime_parachains::configuration::HostConfiguration {
