...
use runtime_common::{
	impls::DealWithFees, paras_registrar, paras_sudo_wrapper, prod_or_fast, slots, BlockHashCount,
...
use cardamom_runtime_constants::{currency::*, fee::*, time::*};
...
/// Runtime version (Cardamom).
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("cardamom"),
	impl_name: create_runtime_str!("elexeum-cardamom"),
	authoring_version: 1,
	spec_version: 202,
	impl_version: 0,
...
parameter_types! {
	pub const IndexDeposit: Balance = 5000 * CENTS;
}
...
parameter_types! {
	...
	pub const SlashDeferDuration: sp_staking::EraIndex = 12;
...
parameter_types! {
	pub const CandidacyBond: Balance = 5000 * CENTS;
...
parameter_types! {
	...
	pub const FriendDepositFactor: Balance = 3 * UNITS;
...
sp_api::impl_runtime_apis! {
	...
	impl frame_try_runtime::TryRuntime<Block> for Runtime {
		fn on_runtime_upgrade() -> (Weight, Weight) {
			log::info!("try-runtime::on_runtime_upgrade elexeum.");
