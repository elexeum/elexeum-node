...
//! EXECUTION: Some(Wasm), WASM-EXECUTION: Compiled, CHAIN: Some("cardamom-dev"), DB CACHE: 128
...
// --output=./runtime/cardamom/src/weights/xcm/pallet_xcm_benchmarks_fungible.rs
