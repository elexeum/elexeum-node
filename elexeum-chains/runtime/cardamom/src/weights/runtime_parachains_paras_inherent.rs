...
//! EXECUTION: Some(Wasm), WASM-EXECUTION: Compiled, CHAIN: Some("cardamom-dev"), DB CACHE: 1024
...
// --output=./runtime/cardamom/src/weights/runtime_parachains_paras_inherent.rs
