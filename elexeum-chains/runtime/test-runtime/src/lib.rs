...
use elexeum_runtime_parachains::{
...
use elexeum_runtime_parachains::reward_points::RewardValidatorsWithEraPoints;
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("elexeum-test-runtime"),
	impl_name: create_runtime_str!("parity-elexeum-test-runtime"),
	authoring_version: 2,
	spec_version: 1056,
	impl_version: 0,
...
sp_api::impl_runtime_apis! {
	...
	impl babe_primitives::BabeApi<Block> for Runtime {
		fn configuration() -> babe_primitives::BabeGenesisConfiguration {
			...
			// <https://research.web3.foundation/en/latest/elexeum/BABE/Babe/#6-practical-results>
