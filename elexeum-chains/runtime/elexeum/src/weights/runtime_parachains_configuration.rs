...
//! EXECUTION: Some(Wasm), WASM-EXECUTION: Compiled, CHAIN: Some("elexeum-dev"), DB CACHE: 1024

// Executed Command:
// target/release/elexeu,
// benchmark
// --chain=elexeum-dev
// --steps=50
// --repeat=20
...
// --output=./runtime/elexeum/src/weights/runtime_parachains_configuration.rs
