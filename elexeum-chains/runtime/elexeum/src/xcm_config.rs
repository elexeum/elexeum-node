...
//! XCM configurations for the Elexeum runtime.   
...
parameter_types! {
	...
	/// Elexeum is a top-level relay-chain, there is no ancestry.
...
pub type SovereignAccountOf = (
	...
	AccountId32Aliases<ElexeumNetwork, AccountId>,
);
...
pub type LocalOriginToLocation = (
	...
	SignedToAccountId32<Origin, AccountId, ElexeumNetwork>,
);
